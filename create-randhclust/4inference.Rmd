...
$$
b_i=\frac{\bar X_{C_1}-\bar X_{C_2}}{\sqrt{1/|C_1|+1/|C_2|}}\cdot\begin{cases}1/|C_1|\text{ for }i\in C_1\\
...
$$
\|b\|^2=\frac{\|\bar X_{C_1}-\bar X_{C_2}\|^2}{1/|C_1|+1/|C_2|}\cdot\left(|C_1|(1/|C_1|)^2+|C_2|(1/|C_2|^2)\right)=\|\bar X_{C_1}-\bar X_{C_2}\|^2
$$
...
tt <- 59 # last merge, when only two clusters remain
...
n <- 40
p <- 2
tt <- 39 # test when there are only two clusters
tau <- 0.2
nsim <- 4
pvals <- rep(NA, nsim)
for (i in seq(nsim)) {
...
Let's try Judy's adaptive grid-based summation approach:
